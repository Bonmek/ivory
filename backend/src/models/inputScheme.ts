...
export const inputSetSuiNSScheme = z.object({
  object_id: z.string().regex(/^0x[a-fA-F0-9]{64}$/),
...
export const inputWriteBlobScheme = z
  .object({
    ...
    blobId: z.string().regex(/^0x[a-fA-F0-9]{64}$/).optional(),
  })
...
//   .object({
//     old_object_id: z.string().regex(/^0x[a-fA-F0-9]{64}$/).optional(),
//     blobId: z.string().regex(/^0x[a-fA-F0-9]{64}$/).optional(),
//     owner: z.string().regex(/^0x[a-fA-F0-9]{64}$/).optional(),
//     ownership: z.union([z.literal("0"), z.literal("1")]).optional(),
//     send_to: z.string().regex(/^0x[a-fA-F0-9]{64}$/).optional(),
//     epochs: z.string().regex(/^\d+$/).optional(),
//     start_date: z.string().refine((val) => !isNaN(Date.parse(val)), {
//       message: "Invalid start_date",
//     }),
//     end_date: z.string().refine((val) => !isNaN(Date.parse(val)), {
...
//     cache: z.string().regex(/^\d+$/).optional(),
//     root: z.string().optional(),
//     install_command: z.string().min(3).optional(),
//     build_command: z.string().min(3).optional(),
//     default_route: z.string().optional(),
//     is_build: z.union([z.literal("0"), z.literal("1")]).optional(),
//     sui_ns: z.string().regex(/^0x[a-fA-F0-9]{64}$/).optional(),
