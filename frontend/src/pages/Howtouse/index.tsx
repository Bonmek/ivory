      ...
      <div className="flex p-8">
        ...
        <div className="w-3/4 pr-8">
          <h1
            ...
            className="text-4xl font-bold mb-4 scroll-mt-30 font-pixel"
          >
            How to launch website with us
          </h1>
          ...
          <div className="flex justify-between items-center mb-6">
            <h1
              ...
              className="text-4xl font-bold scroll-mt-30 font-pixel"
            >
              How to bind Sui NS
            </h1>
            <button
              className="hover:bg-red-600 px-4 py-2 rounded 
            bg-gradient-to-r from-secondary-500 to-secondary-600 text-black font-pixel"
            >
              Dashboard
            </button>
          </div>
          ...
          <div>
            ...
            <div className="border border-gray-700 rounded-lg p-4 mb-6">
              ...
              <ul className="text-gray-300 space-y-1">
                ...
                <li>
                  • Names are case-insensitive (example.sui = EXAMPLE.sui)
                </li>
                <li>
        ...
        {/* Right Sidebar */}
        <div className="w-1/4 p-4 border-l border-gray-700 fixed right-0 top-20 h-[calc(100vh-72px)] overflow-auto">
          <h3 className="text-lg font-semibold mb-4 font-pixel">On this page</h3>
