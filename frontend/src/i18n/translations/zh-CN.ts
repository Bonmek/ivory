export default {
  ...
  'aboutus.project.definition': 'Ivory是一个先进的部署平台，旨在简化使用Walrus存储的静态网站托管。我们的使命是让Web3托管变得触手可及、成本效益高且高效，为全球开发者服务。',
  ...
  'aboutus.goals.title': '我们的目标',
  'aboutus.goals.1': '增加在Sui和Walrus生态系统中的用户采用率',
  'aboutus.goals.2': '在Web托管市场占据重要份额',
  'aboutus.goals.3': '降低部署静态网站的复杂性和成本',
  'aboutus.team.title': 'Kursui团队',
  'aboutus.team.description': '我们是一支致力于通过创新解决方案革新Web3部署的开发团队。',
  'aboutus.contact.title': '联系我们',
