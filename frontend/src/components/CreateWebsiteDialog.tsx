...
function CreateWebsiteDialog({ open, setOpen }: { open: boolean, setOpen: (open: boolean) => void }) {
  const [openSuiLogin, setOpenSuiLogin] = useState(false);

  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-primary-900 max-w-2xl sm:max-w-3xl">
          <DialogHeader>
            <DialogTitle className="text-2xl text-center font-bold mb-2 font-pixel">Are you ready to deploy your website?</DialogTitle>
          </DialogHeader>
