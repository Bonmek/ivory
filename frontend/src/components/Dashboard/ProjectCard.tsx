...
import { MoreHorizontal, Users, CalendarIcon, RefreshCw, Trash, ExternalLink } from 'lucide-react'
...
const ProjectCard = memo(({ project, index, onHoverStart, onHoverEnd }: ProjectCardProps) => {
